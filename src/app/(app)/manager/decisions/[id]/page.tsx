...
export default async function ManagerDecisionDetailPage({ params }: PageProps) {
  ...
  return (
    <>
      <PageHeader
        ...
        breadcrumbs={['Manager', 'Decisions', decision.title]}
      />
      ...
      <div className="mt-6">
        <Button variant="outline" render={<Link href="/manager/decisions" />}>
          Back to decisions
        </Button>
      </div>
    </>
